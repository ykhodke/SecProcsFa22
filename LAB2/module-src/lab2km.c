/*
 * lab2km.c
 * The kernel module for Lab 2 (Securing Processor Architectures - Fall 2022)
...
MODULE_DESCRIPTION("Lab 2 for Securing Processor Architectures - Fall 2022");

// The secrets you're trying to leak!
static volatile char __attribute__((aligned(32768))) kernel_secret3[LAB2_SECRET_MAX_LEN] = "SecProcs{h4rd3st}";
static volatile char __attribute__((aligned(32768))) kernel_secret2[LAB2_SECRET_MAX_LEN] = "SecProcs{scary_sp3ctr3!}";
static volatile char __attribute__((aligned(32768))) kernel_secret1[LAB2_SECRET_MAX_LEN] = "SecProcs{k3rn3l_m3m0r135}";
